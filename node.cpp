...
QVariant Node::itemChange(GraphicsItemChange change, const QVariant &value)
{
    ...
    case ItemPositionHasChanged:
        foreach (Edge *edge, edgeList) {
            edge->setLine(edge->GetStartNode()->x(), edge->GetStartNode()->y(), edge->GetEndNode()->x(), edge->GetEndNode()->y());
        }
        break;
    default:
        break;
...
QColor Node::GetNodeColor() const noexcept {return nodeColor;}
...
QColor Node::GetPenColor() const noexcept {return pen.color();}
